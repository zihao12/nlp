...
class WAC_ATT_2(nn.Module):

	def __init__(self, embedding_dim, vocab_size):
		super(WAC_ATT_2, self).__init__()
	...
	def forward(self, X, lens):
		...
		embeds_ave = torch.mul(att.view(batch_size,-1,1), self.linear0(embeds)).sum(dim = 1)
...
def main():
	...
	PATH = "../model/wac_att_2.pt"

	## define model
	model = WAC_ATT_2(EMBEDDING_DIM, VOCAB_SIZE)
